 ...
 * @since 4.0
 */
public interface StatefulRedisPushConnection<K, V> extends StatefulRedisConnection<K, V> {
    /**
     * Add a new {@link RedisPushListener listener}.
     *
     * @param listener the listener, must not be {@literal null}.
     */
    void addListener(RedisPushListener listener);
     ...
     * @param listener the listener, must not be {@literal null}.
     */
    void removeListener(RedisPushListener listener);
}
